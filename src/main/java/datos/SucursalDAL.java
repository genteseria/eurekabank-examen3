...
public class SucursalDAL {
    ...
    private static SucursalDAL sucursalDAL;
    ...
    public static synchronized SucursalDAL INSTANCIA() {
        if (sucursalDAL == null) {
            sucursalDAL = new SucursalDAL();
            System.out.println(ANSI_BLUE + "Se creó una instancia" + ANSI_BLUE);
        } else {
            System.out.println(ANSI_BLUE + "Está utilizando una misma instancia" + ANSI_BLUE);
        }
        return sucursalDAL;
    }
