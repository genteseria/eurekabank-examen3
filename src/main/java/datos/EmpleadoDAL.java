...
public class EmpleadoDAL {
    ...
    public static synchronized EmpleadoDAL INSTANCIA(){
        if (empleadoDAL == null) {
            empleadoDAL = new EmpleadoDAL();
            System.out.println(ANSI_CYAN + "Se creó una instancia" + ANSI_CYAN);
        } else {
            System.out.println(ANSI_CYAN + "Está utilizando una misma instancia" + ANSI_CYAN);
        }
        return empleadoDAL;
    }
    ...
    public ArrayList<Empleado> obtenerEmpleado(String codigo) {
