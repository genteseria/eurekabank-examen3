...
public class EmpleadoBL {
    private static EmpleadoBL empleadoBL;
    private static EmpleadoDAL empleadoDAL;
    private static ArrayList<Empleado> lista = new ArrayList<>();
    public static final String ANSI_GREEN = "\u001B[32m";
    
    private EmpleadoBL() {
        empleadoDAL  = EmpleadoDAL.INSTANCIA();
    }

    public static synchronized EmpleadoBL INSTANCIA(){
        if (empleadoBL == null) {
            empleadoBL = new EmpleadoBL();
            System.out.println(ANSI_GREEN + "Se creó una instancia" + ANSI_GREEN);
        } else {
            System.out.println(ANSI_GREEN + "Está utilizando una misma instancia" + ANSI_GREEN);
        }
        return empleadoBL;
    }
    
    public int insertarEmpleado(String codigo, String paterno, String materno,
